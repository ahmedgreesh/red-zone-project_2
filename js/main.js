...
const translations = {
    en: {
        ...
        // Refund Page EN
        refund_badge: "Refund Policy",
        refund_hero_title: "Refund & <span>Compensation</span> Policy",
        refund_hero_desc: "Learn about available and unavailable compensation cases, and how to apply for support. Full transparency regarding your rights.",
        refund_s1_title: "No-Refund Cases",
        refund_s1_desc: "No refund or compensation is available in the following cases. Please read carefully before completing your purchase:",
        refund_s1_x1: "<i class=\"fas fa-times-circle\"></i> Change of mind after product delivery and activation",
        refund_s1_x2: "<i class=\"fas fa-times-circle\"></i> Account ban resulting from policy violations or misuse",
        refund_s1_x3: "<i class=\"fas fa-times-circle\"></i> Sharing, reselling, or transferring account ownership without permission",
        refund_s1_x4: "<i class=\"fas fa-times-circle\"></i> Technical issues caused by user error or device incompatibility",
        refund_s1_x5: "<i class=\"fas fa-times-circle\"></i> Requests submitted after the warranty period has ended",
        refund_s2_title: "Available Compensation Cases",
        refund_s2_desc: "Compensation is available when one of the following cases applies and is verified by our support team:",
        refund_s2_c1: "<i class=\"fas fa-check-circle\"></i> Product not delivered or inaccessible due to our error",
        refund_s2_c2: "<i class=\"fas fa-check-circle\"></i> Permanent ban without any violation from the customer <strong style=\"color: var(--red);\"> (within 45-day warranty)</strong>",
        refund_s2_c3: "<i class=\"fas fa-check-circle\"></i> Login issues covered under the access warranty for <strong style=\"color: var(--red);\">24 months</strong>",
        refund_s3_title: "Compensation Request Procedure",
        refund_s3_desc: "To submit a compensation request, follow these steps:",
        refund_step1_title: "Contact Support",
        refund_step1_desc: "Reach our support team via WhatsApp with order details and a clear description of the issue.",
        refund_step2_title: "Review & Verification",
        refund_step2_desc: "After verifying the request and confirming the case, our team will offer one of the appropriate solutions.",
        refund_step3_title: "Apply the Solution",
        refund_step3_desc: "The agreed solution will be applied within the specified timeframe.",
        refund_solutions_heading: "Available Solutions",
        refund_sol1: "Fix the issue and restore access",
        refund_sol2: "Provide a replacement product of equal value",
        refund_sol3: "Partial compensation up to 50% of the product value",
        refund_s4_title: "Processing Time",
        refund_time1_title: "Most Issues",
        refund_time1_desc: "Resolved within <strong style=\"color: #ffcc00;\">24\u201348 hours</strong> of submission",
        refund_time2_title: "Replacement Products",
        refund_time2_desc: "May take up to <strong style=\"color: #ffcc00;\">7 days</strong> if products are not immediately available",
        refund_s5_title: "Important Notes",
        refund_note1: "<i class=\"fas fa-shield-halved\"></i> All compensation requests are subject to review and approval by the management team",
        refund_note2: "<i class=\"fas fa-rotate-right\"></i> Compensation is granted once per account \u2014 no additional claims are allowed",
        refund_contact_title: "<i class=\"fas fa-headset\"></i> Contact Support",
        refund_contact_desc: "Reach us via <strong>WhatsApp</strong> with your order number, product name, and a clear description of the issue for the fastest resolution.",
        // Legal Page EN
        legal_badge: "Legal Notice",
        legal_hero_title: "Legal <span>Notice</span>",
        legal_hero_desc: "Comprehensive information about the company's identity, business nature, liability limits, and applicable intellectual property rights.",
        legal_s1_title: "Company Information",
        legal_company_label: "Platform Name",
        legal_company_name: "Red Zone — An independent platform acting as a mediator in digital gaming services.",
        legal_founded_label: "Founded",
        legal_founded_date: "<i class=\"fas fa-calendar-check\"></i> August 18, 2018",
        legal_s2_title: "Nature of Business",
        legal_s2_l1: "We facilitate access to PlayStation Plus subscriptions, digital games, and accounts.",
        legal_s2_l2: "Services are provided through official purchasing and shipping channels.",
        legal_s2_l3: "We use certified channels such as gift cards and licensed digital services.",
        legal_s3_title: "Disclaimer",
        legal_s3_d1: "<i class=\"fas fa-triangle-exclamation\"></i> Red Zone is not officially affiliated with or representative of Sony Interactive Entertainment.",
        legal_s3_d2: "<i class=\"fas fa-triangle-exclamation\"></i> We are not affiliated with any hardware or game manufacturer.",
        legal_s4_title: "Intellectual Property",
        legal_s4_l1: "<i class=\"fas fa-check-circle\"></i> PlayStation, PS4, PS5 and related marks are trademarks of Sony Interactive Entertainment.",
        legal_s4_l2: "<i class=\"fas fa-check-circle\"></i> All game titles and logos are trademarks of their respective publishers.",
        legal_s4_l3: "<i class=\"fas fa-check-circle\"></i> Use of these marks is for identification purposes only.",
        legal_s5_title: "Compliance & Transparency",
        legal_s5_heading: "Our Commitment",
        legal_s5_text: "We are committed to full transparency in presenting our services, methods of execution, and usage policies. We strive to provide reliable services in accordance with applicable laws, ensuring a safe and fair experience for all parties.",
        // Privacy Page EN
        privacy_badge: "Privacy Policy",
        privacy_hero_title: "Privacy <span>Policy</span>",
        privacy_hero_desc: "We respect your privacy and are committed to protecting your personal data. Learn how we collect, use, and safeguard your information.",
        privacy_s1_title: "Information We Collect",
        privacy_info1_title: "Contact Information",
        privacy_info1_desc: "Your phone number and WhatsApp number that you provide when placing orders.",
        privacy_info2_title: "Order Information",
        privacy_info2_desc: "Details of your purchases, order history, and transaction records.",
        privacy_info3_title: "Device Information",
        privacy_info3_desc: "Browser type, IP address, and device identifiers for security and analytics purposes.",
        privacy_s2_title: "How We Use Your Information",
        privacy_s2_l1: "To create and manage your account on our platform.",
        privacy_s2_l2: "To process and fulfill your orders.",
        privacy_s2_l3: "To provide customer support and technical assistance via WhatsApp.",
        privacy_s2_l4: "To send order confirmations and delivery notifications.",
        privacy_s2_l5: "To improve our services and user experience.",
        privacy_s3_title: "Data Sharing & Disclosure",
        privacy_s3_l1: "We do not sell, trade, or rent your personal information to third parties.",
        privacy_s3_l2: "We may share your information only with payment processors to complete transactions.",
        privacy_s3_l3: "We may disclose information when required by law or to protect our legal rights.",
        privacy_s4_title: "Data Security",
        privacy_s4_i1: "<i class=\"fas fa-check-circle\"></i> We implement industry-standard security measures to protect your personal data.",
        privacy_s4_i2: "<i class=\"fas fa-check-circle\"></i> All data transfers are encrypted using SSL/TLS protocols.",
        privacy_s4_i3: "<i class=\"fas fa-check-circle\"></i> Access to personal data is limited to authorized personnel only.",
        privacy_s5_title: "Data Retention",
        privacy_s5_l1: "We retain your account information as long as your account is active.",
        privacy_s5_l2: "Order records are retained for warranty and support purposes as outlined in our Usage Policy.",
        privacy_s5_l3: "You may request deletion of your account and associated data at any time by contacting our support team.",
        privacy_s6_title: "Your Rights",
        privacy_right1_title: "Access",
        privacy_right1_desc: "You may request a copy of the personal data we hold about you.",
        privacy_right2_title: "Correction",
        privacy_right2_desc: "You may request correction of any inaccurate personal data.",
        privacy_s7_title: "Changes to This Policy",
        privacy_s7_heading: "Update Notice",
        privacy_s7_text: "We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the effective date.",
        ...
        policy_s5_title: "Fifth: Devices Policy (PS4 / PS5) - RedZone",
        policy_s5_sub1: "First: Device Compatibility",
        policy_s5_1_l1: "All accounts work on PS4 and PS5 according to the account type",
        policy_s5_1_l2: "Some games may have a dedicated PS5 version",
        policy_s5_sub2: "Second: Operating System on PS5",
        policy_s5_2_l1: "PS4 Primary accounts cannot be run or activated on a PS5 device",
        policy_s5_2_desc: "If using the account on a PS5 device:",
        policy_s5_2_l2: "Usage is available as Secondary only",
        policy_s5_2_l3: "The account cannot be activated as Primary at all",
        policy_s5_sub3: "Third: Primary Account System (PS4)",
        policy_s5_3_desc1: "When purchasing a Primary PS4 account:",
        policy_s5_3_l1: "You pay for activation on a PS4 device only",
        policy_s5_3_l2: "Activation is restricted to one device",
        policy_s5_3_desc2: "In case of purchasing a PS5 device later:",
        policy_s5_3_l3: "The account cannot be transferred or used as Primary on PS5",
        policy_s5_sub4: "Fourth: Transferring Account Between Devices",
        policy_s5_4_l1: "Account transfer is not available unless the account is strictly Secondary",
        policy_s5_4_desc1: "Since the Secondary account works on:",
        policy_s5_4_l2: "PS4",
        policy_s5_4_l3: "PS5",
        policy_s5_4_l4: "Therefore, there is no issue using it on any device",
        policy_s5_4_l5: "And you cannot request transferring or changing the account",
        policy_s5_4_note: "Due to the difference in account pricing based on its type (Primary / Secondary)",
        policy_s5_sub5: "Fifth: Change or Upgrade Requests",
        policy_s5_5_desc: "Any request to change the account type or transfer it:",
        policy_s5_5_l1: "Is subject to administration approval",
        policy_s5_5_l2: "May require paying a price difference (if any)",
        policy_s5_5_l3: "The store reserves the right to accept or reject the request",
        policy_s5_sub6: "Sixth: Usage Policy",
        policy_s5_6_l1: "Registering the account as a Guest is not allowed",
        policy_s5_6_l2: "You must adhere to the provided activation method",
        policy_s5_6_l3: "Any misuse may lead to the loss of the account without compensation",
        policy_s5_sub7: "Seventh: Reactivation",
        policy_s5_7_desc: "In case of changing the device or formatting:",
        policy_s5_7_l1: "Contact support",
        policy_s5_7_l2: "Reactivation fees may apply",
        ...
        plus_t1_name: "ESSENTIAL",
        plus_t1_f1: "<b>Online Multiplayer:</b> Play with friends and the global community.",
        plus_t1_f2: "<b>Monthly Games:</b> Two PS4 and one PS5 game every month.",
        plus_t1_f3: "<b>Exclusive Discounts:</b> Special member-only prices.",
        plus_t1_f4: "<b>Cloud Storage:</b> 100GB of storage for your game saves.",
        plus_t1_f5: "<b>Share Play:</b> Let friends watch you play or take control.",
        plus_t2_badge: "Best Value",
        plus_t2_name: "EXTRA",
        plus_t2_f1: "<b>All Essential Benefits:</b> Everything in Essential is yours.",
        plus_t2_f2: "<b>Game Catalog:</b> Access up to 400 blockbuster PS4 & PS5 games.",
        plus_t2_f3: "<b>Ubisoft+ Classics:</b> Play iconic titles like Assassin's Creed.",
        plus_t2_f4: "<b>Download & Play:</b> All catalog games available for download.",
        plus_t3_badge: "The Ultimate Experience",
        plus_t3_name: "PREMIUM",
        plus_t3_f1: "<b>All Extra & Essential:</b> Every benefit from other tiers.",
        plus_t3_f2: "<b>Classics Catalog:</b> Hundreds of games from original PS, PS2, PSP & PS3.",
        plus_t3_f3: "<b>Game Trials:</b> Try selected blockbusters before you buy.",
        plus_t3_f4: "<b>Cloud Streaming:</b> Stream PS5 titles from the catalog.",
        plus_t3_f5: "<b>Sony Pictures Core:</b> Access a selection of premium movies."
    },
    ar: {
        nav_home: "الرئيسية",
        nav_games: "الألعاب",
        ...
        policy_s5_title: "خامساً: سياسة الأجهزة (PS4 / PS5) - RedZone",
        policy_s5_sub1: "أولاً: توافق الأجهزة",
        policy_s5_1_l1: "جميع الحسابات تعمل على أجهزة PS4 و PS5 حسب نوع الحساب",
        policy_s5_1_l2: "بعض الألعاب قد يكون لها نسخة مخصصة للـ PS5",
        policy_s5_sub2: "ثانيًا: نظام التشغيل على PS5",
        policy_s5_2_l1: "لا يمكن تشغيل أو تفعيل حسابات PS4 كـ Primary على جهاز PS5",
        policy_s5_2_desc: "في حال استخدام الحساب على جهاز PS5:",
        policy_s5_2_l2: "يكون الاستخدام متاح بنظام Secondary فقط",
        policy_s5_2_l3: "لا يمكن تفعيل الحساب كـ Primary نهائيًا",
        policy_s5_sub3: "ثالثًا: نظام حساب Primary (PS4)",
        policy_s5_3_desc1: "عند شراء حساب Primary PS4:",
        policy_s5_3_l1: "أنت تدفع مقابل التفعيل على جهاز PS4 فقط",
        policy_s5_3_l2: "التفعيل مخصص لجهاز واحد",
        policy_s5_3_desc2: "في حالة شراء جهاز PS5 لاحقًا:",
        policy_s5_3_l3: "لا يمكن نقل الحساب أو استخدامه كـ Primary على PS5",
        policy_s5_sub4: "رابعًا: نقل الحساب بين الأجهزة",
        policy_s5_4_l1: "غير متاح نقل الحساب إلا إذا كان الحساب Secondary فقط",
        policy_s5_4_desc1: "حيث أن الحساب السكندري يعمل على:",
        policy_s5_4_l2: "PS4",
        policy_s5_4_l3: "PS5",
        policy_s5_4_l4: "وبالتالي لا توجد أي مشكلة في استخدامه على أي جهاز",
        policy_s5_4_l5: "ولا يمكن المطالبة بنقل الحساب أو تغييره",
        policy_s5_4_note: "نظرًا لاختلاف تسعير الحسابات حسب نوعها (Primary / Secondary)",
        policy_s5_sub5: "خامسًا: طلبات التغيير أو الترقية",
        policy_s5_5_desc: "أي طلب لتغيير نوع الحساب أو نقله:",
        policy_s5_5_l1: "يخضع لموافقة الإدارة",
        policy_s5_5_l2: "قد يتطلب دفع فرق سعر (إن وجد)",
        policy_s5_5_l3: "يحق للمتجر قبول أو رفض الطلب",
        policy_s5_sub6: "سادسًا: سياسة الاستخدام",
        policy_s5_6_l1: "لا يُسمح بتسجيل الحساب كـ Guest",
        policy_s5_6_l2: "يجب الالتزام بطريقة التفعيل المرسلة",
        policy_s5_6_l3: "أي استخدام خاطئ قد يؤدي لفقدان الحساب بدون تعويض",
        policy_s5_sub7: "سابعًا: إعادة التفعيل",
        policy_s5_7_desc: "في حالة تغيير الجهاز أو الفورمات:",
        policy_s5_7_l1: "يتم التواصل مع الدعم",
        policy_s5_7_l2: "قد يتم فرض رسوم إعادة تفعيل",
        // Usage Policy Modal
        ...
        // Refund Page AR
        refund_badge: "سياسة الاسترداد",
        refund_hero_title: "سياسة <span>الاسترداد</span> والتعويض",
        refund_hero_desc: "تعرّف على حالات التعويض المتاحة وغير المتاحة، وكيفية التقديم للحصول على الدعم. الشفافية الكاملة تجاه حقوقك.",
        refund_s1_title: "حالات عدم الاسترداد",
        refund_s1_desc: "لا يتوفر استرداد أو تعويض في الحالات التالية، يرجى الاطلاع عليها بعناية قبل إتمام الشراء:",
        refund_s1_x1: "<i class=\"fas fa-times-circle\"></i> تغيير الرأي بعد تسليم المنتج وتفعيله",
        refund_s1_x2: "<i class=\"fas fa-times-circle\"></i> حظر الحساب الناتج عن مخالفة السياسات أو سوء الاستخدام",
        refund_s1_x3: "<i class=\"fas fa-times-circle\"></i> مشاركة الحساب أو إعادة بيعه أو نقل ملكيته دون إذن",
        refund_s1_x4: "<i class=\"fas fa-times-circle\"></i> المشاكل التقنية الناتجة عن خطأ المستخدم أو عدم توافق الجهاز",
        refund_s1_x5: "<i class=\"fas fa-times-circle\"></i> الطلبات المقدمة بعد انتهاء فترة الضمان",
        refund_s2_title: "حالات التعويض المتاحة",
        refund_s2_desc: "يتوفر التعويض عند توافر إحدى الحالات التالية وبعد التحقق منها من قِبل فريق الدعم:",
        refund_s2_c1: "<i class=\"fas fa-check-circle\"></i> عدم تسليم المنتج أو عدم إمكانية الوصول بسبب خطأ منّا",
        refund_s2_c2: "<i class=\"fas fa-check-circle\"></i> الحظر الدائم بدون مخالفة من العميل <strong style=\"color: var(--red);\">(خلال ضمان 45 يوم)</strong>",
        refund_s2_c3: "<i class=\"fas fa-check-circle\"></i> مشاكل تسجيل الدخول المشمولة بضمان الوصول لمدة <strong style=\"color: var(--red);\">24 شهر</strong>",
        refund_s3_title: "إجراءات طلب التعويض",
        refund_s3_desc: "للتقديم على طلب تعويض، اتبع الخطوات التالية:",
        refund_step1_title: "التواصل مع الدعم",
        refund_step1_desc: "تواصل مع فريق الدعم عبر الواتساب مع تفاصيل الطلب ووصف المشكلة بوضوح.",
        refund_step2_title: "التحقق والمراجعة",
        refund_step2_desc: "بعد التحقق من الطلب وتأكيد الحالة، سيقوم فريقنا بتقديم أحد الحلول المناسبة.",
        refund_step3_title: "تنفيذ الحل",
        refund_step3_desc: "يتم تطبيق الحل المتفق عليه خلال الفترة الزمنية المحددة.",
        refund_solutions_heading: "الحلول المقدمة",
        refund_sol1: "إصلاح المشكلة واستعادة الوصول",
        refund_sol2: "توفير منتج بديل بنفس القيمة",
        refund_sol3: "تعويض جزئي يصل إلى 50% من قيمة المنتج",
        refund_s4_title: "وقت المعالجة",
        refund_time1_title: "معظم المشاكل",
        refund_time1_desc: "يتم الحل خلال <strong style=\"color: #ffcc00;\">24 – 48 ساعة</strong> من تقديم الطلب",
        refund_time2_title: "المنتجات البديلة",
        refund_time2_desc: "قد تستغرق حتى <strong style=\"color: #ffcc00;\">7 أيام</strong> إذا لم تكن المنتجات متوفرة فوراً",
        refund_s5_title: "ملاحظات هامة",
        refund_note1: "<i class=\"fas fa-shield-halved\"></i> جميع طلبات التعويض تخضع للتحقق والموافقة من فريق الإدارة",
        refund_note2: "<i class=\"fas fa-rotate-right\"></i> يتم التعويض لمرة واحدة فقط لكل حساب — لا يحق المطالبة بتعويض إضافي",
        refund_contact_title: "<i class=\"fas fa-headset\"></i> للتواصل مع الدعم",
        refund_contact_desc: "تواصل معنا عبر <strong>واتساب</strong> مع ذكر رقم الطلب، اسم المنتج، وتفاصيل المشكلة بوضوح لضمان أسرع معالجة ممكنة.",
        // Legal Page AR
        legal_badge: "الإشعار القانوني",
        legal_hero_title: "الإشعار <span>القانوني</span>",
        legal_hero_desc: "معلومات شاملة عن هوية الشركة، طبيعة عملها، حدود مسؤوليتها، وحقوق الملكية الفكرية المعمول بها.",
        legal_s1_title: "معلومات الشركة",
        legal_company_label: "اسم المنصة",
        legal_company_name: "Red Zone — منصة مستقلة تعمل كوسيط في مجال الخدمات الرقمية للألعاب.",
        legal_founded_label: "تاريخ التأسيس",
        legal_founded_date: "<i class=\"fas fa-calendar-check\"></i> 18 أغسطس 2018",
        legal_s2_title: "طبيعة العمل",
        legal_s2_l1: "نقوم بتسهيل الحصول على اشتراكات PlayStation Plus والألعاب الرقمية والحسابات.",
        legal_s2_l2: "يتم تقديم الخدمات من خلال قنوات الشراء والشحن الرسمية.",
        legal_s2_l3: "نستخدم قنوات معتمدة مثل بطاقات الهدايا والخدمات الرقمية المرخصة.",
        legal_s3_title: "إخلاء المسؤولية",
        legal_s3_d1: "<i class=\"fas fa-triangle-exclamation\"></i> Red Zone ليست تابعة رسميًا أو ممثلة لشركة Sony Interactive Entertainment.",
        legal_s3_d2: "<i class=\"fas fa-triangle-exclamation\"></i> نحن غير تابعين لأي جهة مصنّعة للأجهزة أو الألعاب.",
        legal_s4_title: "الملكية الفكرية",
        legal_s4_l1: "<i class=\"fas fa-check-circle\"></i> PlayStation و PS4 و PS5 والعلامات ذات الصلة هي علامات تجارية لشركة Sony Interactive Entertainment.",
        legal_s4_l2: "<i class=\"fas fa-check-circle\"></i> جميع عناوين الألعاب والشعارات هي علامات تجارية لناشريها.",
        legal_s4_l3: "<i class=\"fas fa-check-circle\"></i> استخدام هذه العلامات هو لأغراض التعريف فقط.",
        legal_s5_title: "الامتثال والشفافية",
        legal_s5_heading: "التزامنا",
        legal_s5_text: "نلتزم بالشفافية الكاملة في عرض الخدمات، آلية التنفيذ، وسياسات الاستخدام. نحرص على تقديم خدمات موثوقة وفق القوانين المعمول بها، بما يضمن تجربة آمنة وعادلة لجميع الأطراف.",
        // Privacy Page AR
        privacy_badge: "سياسة الخصوصية",
        privacy_hero_title: "سياسة <span>الخصوصية</span>",
        privacy_hero_desc: "نحن نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية. تعرّف على كيفية جمع المعلومات واستخدامها وحمايتها.",
        privacy_s1_title: "المعلومات التي نجمعها",
        privacy_info1_title: "معلومات الاتصال",
        privacy_info1_desc: "رقم الهاتف ورقم الواتساب الذي تقدمه عند تقديم الطلبات.",
        privacy_info2_title: "معلومات الطلب",
        privacy_info2_desc: "تفاصيل مشترياتك وسجل الطلبات وسجلات المعاملات.",
        privacy_info3_title: "معلومات الجهاز",
        privacy_info3_desc: "نوع المتصفح وعنوان IP ومعرفات الجهاز لأغراض الأمان والتحليلات.",
        privacy_s2_title: "كيف نستخدم معلوماتك",
        privacy_s2_l1: "لإنشاء وإدارة حسابك على منصتنا.",
        privacy_s2_l2: "لمعالجة وتنفيذ طلباتك.",
        privacy_s2_l3: "لتقديم دعم العملاء والمساعدة التقنية عبر الواتساب.",
        privacy_s2_l4: "لإرسال تأكيدات الطلبات وإشعارات التوصيل.",
        privacy_s2_l5: "لتحسين خدماتنا وتجربة المستخدم.",
        privacy_s3_title: "مشاركة البيانات والإفصاح",
        privacy_s3_l1: "نحن لا نبيع أو نتاجر أو نؤجر معلوماتك الشخصية لأطراف ثالثة.",
        privacy_s3_l2: "قد نشارك معلوماتك فقط مع معالجي الدفع لإتمام المعاملات.",
        privacy_s3_l3: "قد نفصح عن المعلومات عندما يتطلب القانون ذلك أو لحماية حقوقنا القانونية.",
        privacy_s4_title: "أمان البيانات",
        privacy_s4_i1: "<i class=\"fas fa-check-circle\"></i> ننفذ إجراءات أمنية وفق معايير الصناعة لحماية بياناتك الشخصية.",
        privacy_s4_i2: "<i class=\"fas fa-check-circle\"></i> جميع عمليات نقل البيانات مشفرة باستخدام بروتوكولات SSL/TLS.",
        privacy_s4_i3: "<i class=\"fas fa-check-circle\"></i> يقتصر الوصول إلى البيانات الشخصية على الموظفين المعتمدين فقط.",
        privacy_s5_title: "الاحتفاظ بالبيانات",
        privacy_s5_l1: "نحتفظ بمعلومات حسابك طالما كان حسابك نشطًا.",
        privacy_s5_l2: "يتم الاحتفاظ بسجلات الطلبات لأغراض الضمان والدعم كما هو موضح في سياسة الاستخدام الخاصة بنا.",
        privacy_s5_l3: "يمكنك طلب حذف حسابك والبيانات المرتبطة به في أي وقت عن طريق التواصل مع فريق الدعم.",
        privacy_s6_title: "حقوقك",
        privacy_right1_title: "الوصول",
        privacy_right1_desc: "يمكنك طلب نسخة من البيانات الشخصية التي نحتفظ بها عنك.",
        privacy_right2_title: "التصحيح",
        privacy_right2_desc: "يمكنك طلب تصحيح البيانات الشخصية غير الدقيقة.",
        privacy_s7_title: "التغييرات على هذه السياسة",
        privacy_s7_heading: "إشعار بالتحديثات",
        privacy_s7_text: "قد نقوم بتحديث سياسة الخصوصية هذه من وقت لآخر. سنخطرك بأي تغييرات عن طريق نشر سياسة الخصوصية الجديدة على هذه الصفحة وتحديث تاريخ السريان.",
        // Plus Page
        ...
        plus_t1_name: "ESSENTIAL",
        plus_t1_f1: "<b>أونلاين متعدد اللاعبين:</b> العب مع أصدقائك والمجتمع العالمي.",
        plus_t1_f2: "<b>ألعاب شهرية:</b> لعبتان PS4 ولعبة PS5 كل شهر.",
        plus_t1_f3: "<b>خصومات حصرية:</b> أسعار خاصة للأعضاء فقط.",
        plus_t1_f4: "<b>تخزين سحابي:</b> 100 جيجابايت لتخزين حفظ الألعاب.",
        plus_t1_f5: "<b>مشاركة اللعب:</b> اجعل أصدقاءك يشاهدون لعبك أو يتحكمون به.",
        plus_t2_badge: "أفضل قيمة",
        plus_t2_name: "EXTRA",
        plus_t2_f1: "<b>كل مزايا Essential:</b> كل ما في الباقة الأساسية لك.",
        plus_t2_f2: "<b>كتالوج الألعاب:</b> وصول لأكثر من 400 لعبة ضخمة لـ PS4 و PS5.",
        plus_t2_f3: "<b>Ubisoft+ Classics:</b> العب ألعاباً شهيرة مثل Assassin's Creed.",
        plus_t2_f4: "<b>التحميل واللعب:</b> جميع ألعاب الكتالوج متاحة للتحميل.",
        plus_t3_badge: "التجربة القصوى",
        plus_t3_name: "PREMIUM",
        plus_t3_f1: "<b>كل مزايا Extra و Essential:</b> كل المزايا من الباقات الأخرى.",
        plus_t3_f2: "<b>كتالوج كلاسيكيات:</b> مئات الألعاب من PS القديم و PS2 و PSP و PS3.",
        plus_t3_f3: "<b>تجارب الألعاب:</b> جرب ألعاباً ضخمة مختارة قبل الشراء.",
        plus_t3_f4: "<b>بث سحابي:</b> بث ألعاب PS5 من الكتالوج.",
        plus_t3_f5: "<b>Sony Pictures Core:</b> وصول لمجموعة مختارة من الأفلام المتميزة."
    }
};
